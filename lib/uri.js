 ...
 * @return {Boolean}
 */
URIStringValidator.isURIFragment = function URIisURIFragment(
  possibleURIFragment
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIIPLiteral = function URIisURIIPLiteral(
  possibleURIIPLiteral
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIIPv6Address = function URIisURIIPv6Address(
  possibleURIIPv6Address
) {
  return false
}
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIIPvFuture = function URIisURIIPvFuture(
  possibleURIIPvFuture
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURILikeObject = function isURILikeObject(
  possibleURILikeObject
) {
  var authority
  var fragment
  var path
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIPathAbempty = function URIisURIPathAbempty(
  possibleURIPathAbempty
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIPathAbsolute = function URIisURIPathAbsolute(
  possibleURIPathAbsolute
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIPathEmpty = function URIisURIPathEmpty(
  possibleURIPathEmpty
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIPathNoScheme = function URIisURIPathNoScheme(
  possibleURIPathNoScheme
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIPathRootless = function URIisURIPathRootless(
  possibleURIPathRootless
) {
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIReference = function URIisURIReference(
  possibleURIReference
) {
  return (
 ...
 * @return {Boolean|URIReference}
 */
URIStringValidator.isURIRelativeRef = function URI(
 ...
 * @return {Boolean}
 */
URIStringValidator.isURIUserInfo = function URIisURIUserInfo(
  possibleURIUserinfo
) {
  var userinfoMatches
  var userinfoRegExp
...
URIStringValidator.uriToString = function URIuriToString(uriObject) {
  ...
  if (typeof uriObject === 'undefined') {
    errorMessage =
      '[URIStringValidator.uriToString] The `uriObject` argument is undefined.'
