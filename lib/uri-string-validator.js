...
function URIisURIAuthority(possibleURIAuthority, returnParse) {
  ...
  var possibleURIUserInfo = null
  var possibleURIHost = null
  var possibleURIPortAndColon = null
  var possibleURIPort = null
  if (Utils.hasMatch(authorityMatches)) {
    possibleURIUserInfo = authorityMatches[1]
    possibleURIHost = authorityMatches[2]
    possibleURIPortAndColon = authorityMatches[3]
    possibleURIPort = authorityMatches[4]
  }
...
function URIisURIOrRelativeRef(possibleURIReference, type, returnParse) {
  ...
  uriPatternHasMatches = Utils.hasMatch(uriMatches)
  possibleURLProtocol = null
  possibleURIScheme = null
  possibleURIPart = null
  possibleURLSearch = null
  possibleURIQuery = null
  possibleURLHash = null
  possibleURIFragment = null
  if (effectiveType === RELATIVE_REF) {
    if (uriPatternHasMatches) {
      // possibleURLProtocol = null
      // possibleURIScheme = null
