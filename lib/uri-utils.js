...
/**
 * Similar to PREG_UNMATCHED_AS_NULL for PHP's `preg_match()` method, however,
 * it does not gauruntee that the return value will be an array since
 * JavaScript's `String.prototype.match()` may return null instead of an array.
 * @param {*} matches
 */
